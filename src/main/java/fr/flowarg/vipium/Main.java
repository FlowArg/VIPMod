...
public class Main
{
    ...
    {
        this.logger.info("FMLSetup is loading Vipium Mod...");
        this.logger.info("Adding new ores to world generation...");
        OreGeneration.setupGeneration();
    }

    private void setupClient(final FMLClientSetupEvent event)
    {
        this.logger.info("FMLSetup is loading Vipium Mod (ClientSideOnly)...");
        DataGenerators.registerDomain(MODID);
        DataGenerators.addModelGenerator(new ModelGeneratorImpl());
        this.logger.info("Registering a new screen factory : Vipium Purifier Screen.");

...
public class VipiumPurifierTileEntity extends LockableTileEntity implements ISidedInventory, ITickableTileEntity
{
    ...
    public boolean isStructureValid()
    {
        if(this.world != null)
        {
            ...
            final ArrayTable<Integer, Integer, Block> table = ArrayTable.create(this.five, this.five);
    ...
    private void purify()
    {
        if(this.timer == 0)
        {
            ...
            {
                if(this.world != null)
                    this.world.createExplosion(this.purifierStorage.getPlayer(), DamageSource.causeExplosionDamage((Explosion)null), this.pos.getX(), this.pos.getY(), this.pos.getZ(), 6f, true, Explosion.Mode.DESTROY);
            }
